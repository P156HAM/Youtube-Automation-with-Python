...
Automated AI workflow that creates funny Discord-style conversation videos and posts them to YouTube.

## Features

- **AI Story Generation**: Uses GPT-4 to create funny Reddit-style conversation stories
